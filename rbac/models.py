...
class Permission(models.Model):
    ...
    menu = models.ForeignKey(verbose_name="二级菜单", to=Menu, null=True, blank=True, on_delete=models.SET_NULL, help_text="nul表示不是菜单;非null表示不是菜单")
    pid = models.ForeignKey(verbose_name="关联权限", help_text="对于非菜单的权限需要选择一个可以成为菜单的权限", to="Permission", null=True, blank=True, on_delete=models.SET_NULL)
